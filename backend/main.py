...
from api import setup, auth, users, permissions, servers, console, settings as settings_api, docker, files
...
app.include_router(files.router, prefix=f"{settings.api_prefix}/servers", tags=["Files"])
